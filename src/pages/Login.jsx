      ...
      <form className="max-w-sm mx-auto" onSubmit={handleSubmit}>
        <div className="flex">
          ...
          <input
            type="text"
            id="website-admin"
            className="rounded-none rounded-e-lg bg-gray-400 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"
